#[cfg(test)]
mod script_tests {
    use bsvsimd::{Hash, OpCodes, P2PKHAddress, Script, ScriptBit};
    // #[test]
    // #[cfg_attr(target_arch = "wasm32", wasm_bindgen_test)]
    // fn to_hex_string() {
    //   let script_bytes = hex_simd::decode_to_vec("").unwrap();
    ...
    fn if_statement_script() {
        ...
        assert_eq!(
            ...
            &[
                ScriptBit::Push(hex_simd::decode_to_vec("21e8").unwrap()),
                ScriptBit::If {
                    code: OpCodes::OP_IF,
    ...
    fn scrypt_stateful_contract() {
        ...
        assert_eq!(
            ...
            &[
                ScriptBit::OpCode(OpCodes::OP_RETURN),
                ScriptBit::OpCode(OpCodes::OP_0),
                ScriptBit::Push(hex_simd::decode_to_vec("01").unwrap()),
                ScriptBit::OpCode(OpCodes::OP_0),
                ScriptBit::Push(hex_simd::decode_to_vec("00").unwrap()),
                ScriptBit::Push(hex_simd::decode_to_vec("00").unwrap()),
                ScriptBit::Push(hex_simd::decode_to_vec("00").unwrap()),
                ScriptBit::Push(hex_simd::decode_to_vec("00").unwrap()),
                ScriptBit::Push(hex_simd::decode_to_vec("00").unwrap()),
                ...
                ScriptBit::Push(hex_simd::decode_to_vec("00").unwrap()),
                ScriptBit::Push(hex_simd::decode_to_vec("00").unwrap()),
                ScriptBit::Push(hex_simd::decode_to_vec("00000000").unwrap()),
            ]
        );
